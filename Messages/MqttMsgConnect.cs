...
namespace M2Mqtt.Messages
{
    ...
    public class MqttMsgConnect : MqttMsgBase
    {
        ...
        public MqttMsgConnect(string clientId) :
            this(
            clientId, null, null, false, QOS_LEVEL_AT_LEAST_ONCE, false, null, null, true, KEEP_ALIVE_PERIOD_DEFAULT,
            ...
            )
        {
            ...
            this.protocolName = (this.protocolVersion == PROTOCOL_VERSION_V3_1_1)
                ? PROTOCOL_NAME_V3_1_1
                : PROTOCOL_NAME_V3_1;
        }
        ...
        public override byte[] GetBytes(byte protocolVersion)
        {
            ...
            byte[] willTopicUtf8 = (this.willFlag && (this.willTopic != null))
                ? Encoding.UTF8.GetBytes(this.willTopic)
                : null;
            byte[] willMessageUtf8 = (this.willFlag && (this.willMessage != null))
                ? Encoding.UTF8.GetBytes(this.willMessage)
                : null;
            byte[] usernameUtf8 = ((this.username != null) && (this.username.Length > 0))
                ? Encoding.UTF8.GetBytes(this.username)
                : null;
            byte[] passwordUtf8 = ((this.password != null) && (this.password.Length > 0))
        ...
        public override string ToString()
        {
            ...
            return this.GetTraceString(
                ...
                new object[]
                {
                    "protocolName", "protocolVersion", "clientId", "willFlag", "willRetain", "willQosLevel", "willTopic",
                    "willMessage", "username", "password", "cleanSession", "keepAlivePeriod"
                },
                new object[]
                {
                    this.protocolName, this.protocolVersion, this.clientId, this.willFlag, this.willRetain,
                    this.willQosLevel, this.willTopic, this.willMessage, this.username, this.password, this.cleanSession,
